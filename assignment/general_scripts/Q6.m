...
% Example: G(s) = 1 / (s + 1)
% Replace the denominator coefficient with the one from Table 1
a = 8; 
G = tf(1, [1 a]);
...
%----defining a single time vector for both plots
t=0:0.01:10;
y1=step(G,t);
y2=step(G_closed,t);
% --- Plot Step Responses ---
...
title('Table 1 – Question 6: First-Order System Compensation (Joshua Wambua)');
